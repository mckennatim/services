...
module.exports = function() {
    ...
    router.put('/updjc', bearerTokenCoid, function(req, res) {
        if (!req.userTok.auth) {
    ...
    router.put('/updpu', bearerTokenCoid, function(req, res) {
        if (!req.userTok.auth) {
    ...
    router.put('/updstat', bearerTokenCoid, function(req, res) {
        if (!req.userTok.auth) {
    ...
    router.get('/wstat/:wk', bearerTokenCoid, function(req, res) {
        if (!req.userTok.auth) {
    ...
    router.get('/week/:wk', bearerTokenCoid, function(req, res) {
        if (!req.userTok.auth) {

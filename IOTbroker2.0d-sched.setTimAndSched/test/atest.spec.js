...
describe('atest.spec  ', function(){
  ...
  it('tries sched.findSched',(done)=>{
    sched.findSched(6, 'CYURD002', (res)=>{
      console.log(res)
  ...
  it('tries sched.setTimeAndSched',(done)=>{
    sched.setTimeAndSched('CYURD002', mosca, (res)=>{
      cons.log(res)
  ...
  it('tries sched.combineScheds',(done)=>{
    let res = sched.combineScheds('[[0,0,58,56]]', '13:43', '[[0,0,64,62], [7,15,69,67], [9,0,63,61], [15,30,68,66], [23,0,63,61]]' )
    console.log(res)
